    ...
    return (
        <div className="card-examen">
            ...
            <div className="card-content">
                {/* El contenido cambia de la tarjeta */}
                {isCardVisible ? (
                    <>
                    {/* Examen microcospico */}
                    ...
                    <>        
                        ...
                        {/* Aqui iria la tabla del examen quimico */}
                        <table className="table-fisico">
                            <thead>
                                <tr className="table-fisico-head">
                                    <th className="table-fisico-header table-fisico-cell table-title" colSpan={3}>
                        ...
                        <div className="next">
                            <svg className="icon-next" onClick={handleRightClick} width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"/>
