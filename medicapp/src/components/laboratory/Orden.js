...
const Orden = ({ onClose, ontipoExamenChange }) => {

    const [tipoExamen, setTipoExamen] = useState("Ninguno");

    const handleTipoExamenChange = (event) => {
        const tipo = event.target.value;
        setTipoExamen(tipo);
        ontipoExamenChange(tipo);
    ...
    return (
        <div className="card">
            ...
            <div className="card-content">
                ...
                <div className="firma">
                    <img src="/firma_medic.png" alt="firma" className="firma-imagen"/>
                    <div className="firma-texto">Firma y código del médico</div>
                </div>
